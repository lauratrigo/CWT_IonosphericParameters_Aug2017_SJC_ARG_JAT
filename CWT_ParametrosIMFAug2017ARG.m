...
% --- 1) Carregar os dados
data = load('mediasionosfericasARG.mat');
foF2 = data.foF2;
hF = data.hF;
hmF2 = data.hmF2;
...
sinais = {foF2, hF, hmF2};
nomesFisicos = {'foF2 - Araguatins (TO)', 'hF - Araguatins (TO)', 'hmF2 - Araguatins (TO)'};
...
% Fonte do título
title(['CWT - ' nomeFisico], 'FontSize', 16, 'FontWeight', 'bold', 'FontName', 'Arial', 'FontWeight', 'bold');
